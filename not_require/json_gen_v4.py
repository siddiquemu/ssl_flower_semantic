...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 11:09:15 2021
...
def inst_ann_gen(outers, segIDs, imgID, bboxes, areas, ann_type='box_mask'):
    inst_ann=[]
...
# =============================================================================
        ...
        #first item in the list is the background: used only in panoptic json
        area = areas[i+1]     
        bbox = bboxes[i+1]
        segID = segIDs[i+1]
        catID = 1
...
if __name__=='__main__':
    ...
    base_dir = '/home/walden/Desktop/otherFlowerDatasets/'+dataset+'/dataFormattedProperly/splitImages4x3/'
    ...
    with open(base_dir+dataset+'_panoptic_split4x3_test.json','w') as f:
        f.write(s)
    ...
    with open(base_dir+dataset+'_instance_split4x3_test.json','w') as f:
        f.write(s)
