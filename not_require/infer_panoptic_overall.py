...
if __name__ == '__main__':
    ...
    data, img_dir, panoptic_masks, sem_seg_masks, \
    panoptic_json, instance_json, outpath, rgbmask_dir, \
    sem_mask_dir, img_fmt, base_dir = get_dirs(dataset='AppleA_test')
    ...
    if not eval_only:
        ...
        cfg, angleSet, class_id,\
        flower_metadata = get_test_config(pretrained=pretrained, test_aug=test_aug,
                                        img_dir=img_dir, panoptic_masks=panoptic_masks,
                                        panoptic_json=panoptic_masks, sem_seg_masks=sem_seg_masks,
        ...
        #Read full resolution image and apply sliding window
